          ...
          <Group justify="space-between">
            <Group>
              ...
              <div>
                ...
                <Text fw={700} size="lg">{data.averageProcessingTime.toFixed(2)} s</Text>
              </div>
            </Group>
          ...
          <Group justify="space-between">
            <Group>
              ...
              <div>
                ...
                <Text fw={700} size="lg">{data.apiResponseTime.toFixed(2)} s</Text>
              </div>
            </Group>
            <Badge 
          ...
          <Group justify="space-between">
            <Group>
              ...
              <div>
                ...
                <Text fw={700} size="lg">{data.modelVersion}</Text>
              </div>
            </Group>
